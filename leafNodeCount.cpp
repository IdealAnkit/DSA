...
void Traversing(BinaryTree *temp)
{
    if (temp == nullptr)
    {
        return;
...
int main()
{
    ...
    root->left->right->left=NewNodeCreation(12);
    root->left->right->right=NewNodeCreation(62);
    root->right->right=NewNodeCreation(92);
